...
class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.setIn(new java.io.FileInputStream("/Users/ludwings/study/algo-java/src/swexpert/이미지검색하기/sample_input.txt"));
        ...
        System.out.println((System.currentTimeMillis() - start) / 1000d + "m/s");
        sc.close();
    }
